...
const smokeFunctions=Object.entries(resources).filter(([id,value])=>(id.startsWith('SmokeReport')||id.startsWith('SmokeAnalysis')||id.startsWith('ReportSmokeRunner'))&&value.Type==='AWS::Lambda::Function');
...
console.log('Smoke workflow is isolated by state machine, secret, prefixes, IAM, and manual runner dispatch.');
